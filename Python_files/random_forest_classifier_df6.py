...
###### ========== USER SETTINGS ========== #######
dataset_name = 'bin0_1_thresh0_5_df_spectra' 
num_loops = 25
...
# def add_tox_levels_for_rf(df, response_col='Response'):
#     """Add Tox levels as integer classes for Random Forest classification"""
#     df = df.copy()
#     df['Tox_level'] = df[response_col].apply(response_to_tox_class)
#     return df
...
# print("=== RANDOM FOREST TOX CLASSIFICATION TRAINING ===")
...
#             super_test_output_df['Response'] = super_test_processed['Response'].values
#             super_test_output_df['log_response'] = super_test_processed['log_response'].values
#             super_test_output_df['Tox_level'] = super_test_processed['Tox_level'].values
#             super_test_output_df['index_id'] = super_test_processed['index'].values
