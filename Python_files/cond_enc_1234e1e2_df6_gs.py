...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        trained_cond_encoder = fd.train_model_condenc_1234e1e2_weightloss(
            ...
            lambda4=lambda4,
            device=device,
            config=chemnet_1234e1e2_weight,
            alpha1=alpha1,
            alpha2=alpha2,
            alpha3=alpha3,
            alpha4=alpha4
        ...
        full_val_output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_1234e1e2"
        ...
        if len(super_test_df) > 0:
            ...
            super_test_output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_1234e1e2_super_test"
