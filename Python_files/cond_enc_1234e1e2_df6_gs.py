...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        regular_test_output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_1234e1e2_outputs"
        os.makedirs(regular_test_output_folder, exist_ok=True)

        regular_test_predictions_filename = f"cond_enc_{bin_part}_{threshold_part}_df_spectra.parquet"
