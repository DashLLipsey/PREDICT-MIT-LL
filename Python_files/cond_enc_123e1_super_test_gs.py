...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        x_train_with_ext, y_train_emb, y_train_tox, y_train_morgan, train_indices_tensor = fd.create_dataset_tensors_condenc_123e1(
                train_data_processed, name_smiles_embedding_df, morgan_df, device, start_idx=1, stop_idx=-5)

        x_val_with_ext, y_val_emb, y_val_tox, y_val_morgan, val_indices_tensor = fd.create_dataset_tensors_condenc_123e1(
        ...
        cond_encoder_current = fd.Cond_Encoder_123e1(input_size=actual_input_size,
        ...
        if super_test_output_df is not None:
            super_test_output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_super_test_123e1"
