...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        chemnet_tox_morgan_config = {
            ...
            'gpu': True,
            'encoder_type': "Conditional Encoder ChemNet + Toxicity + Morgan + Group + clean",
        ...
        output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_123e1e2_outputs"
        os.makedirs(output_folder, exist_ok=True)

        predictions_filename = f"cond_enc_123e1e2_{bin_part}_{threshold_part}_df_spectra.parquet"
