...
print("=== CONDITIONAL ENCODER (ChemNet + Toxicity + Group + CE_clean) TRAINING ===")
...
output_size = 512 + 1  # ChemNet embeddings (512) + Toxicity (1)
print(f"Calculated output size: {output_size} (512 ChemNet + 1 Toxicity)")
...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        # CE-aware train/test split for real spectra only
        ...
        train_dataset = TensorDataset(x_train_with_ext, y_train_emb, y_train_tox, train_indices_tensor)
        val_dataset = TensorDataset(x_val_with_ext, y_val_emb, y_val_tox, val_indices_tensor)
        ...
        chemnet_12e1e2 = {
            ...
            'gpu': True,
            'encoder_type': "Conditional Encoder ChemNet + Toxicity + Group + CE_clean",
        ...
        full_val_output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_12e1e2_outputs_df6"
        ...
        if len(super_test_df) > 0:
            ...
            super_test_output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_12e1e2_supertest_outputs"
        ...
        del x_train_with_ext, x_val_with_ext, y_train_emb, y_train_tox
        del y_val_emb, y_val_tox, train_indices_tensor, val_indices_tensor
        del x_full_val_with_ext, y_full_val_emb, y_full_val_tox, full_val_indices_tensor
        if 'x_super_test_with_ext' in locals():
            del x_super_test_with_ext, y_super_test_emb, y_super_test_tox, super_test_indices_tensor
