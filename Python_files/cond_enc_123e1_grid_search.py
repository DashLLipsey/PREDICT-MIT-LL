...
# allowed_bin_prefixes = [ 'bin1_', 'bin0_5_', 'bin2_'] #'bin0_5_',
...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        x_train_with_group, y_train_emb, y_train_tox, y_train_morgan, train_indices_tensor = fd.create_dataset_tensors_condenc_123e1(
                train_data_processed, name_smiles_embedding_df, morgan_df, device, start_idx=1, stop_idx=-5)

        x_val_with_group, y_val_emb, y_val_tox, y_val_morgan, val_indices_tensor = fd.create_dataset_tensors_condenc_123e1(
        ...
        trained_cond_encoder = fd.train_model_condenc_123e1(
        ...
        x_full_with_group, y_full_emb, y_full_tox, y_full_morgan, full_indices_tensor = fd.create_dataset_tensors_condenc_123e1(
        ...
        output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_123e1_outputs"
        os.makedirs(output_folder, exist_ok=True)

        predictions_filename = f"cond_enc_123e1_{bin_part}_{threshold_part}_df_spectra.parquet"
