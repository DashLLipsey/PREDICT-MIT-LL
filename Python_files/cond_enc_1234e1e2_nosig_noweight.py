...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        # Train/test split for ONLY real spectra, with CE-aware stratification
        ...
        # CRITICAL: Preserve original index_ids throughout - DO NOT reassign
        # Store index_id values before reset_index to maintain tracking
        ...
        # Add 'index' column for tensor function, using index_id (NEVER reassign index_id itself)
        ...
        cond_encoder_current = fd.Cond_Encoder_1234_nosig(input_size=actual_input_size,
        ...
        full_val_output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_1234e1e2_nosig_noweight"
        ...
        if len(super_test_df) > 0:
            ...
            super_test_output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_1234e1e2_nosig_noweight_super_test"
