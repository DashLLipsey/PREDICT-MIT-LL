...
try:
    ...
    print(f"Tensor shape: {x_train_with_ext.shape}")
    print(f"Last 10 values of first 5 rows:")
    print(x_train_with_ext[:5, -10:])
    ...
    chemnet_tox_morgan_config = {
        ...
        'wandb_name': f"cond_enc_123e1e2_{dataset_name}",
        'gpu': True,
    ...
    x_full_with_ext, y_full_emb, y_full_tox, y_full_morgan, full_indices_tensor = fd.create_dataset_tensors_condenc_123e1e2(
    ...
    if len(super_test_df) > 0:
        ...
        def create_dataset_tensors_condenc_123e1e2_consistent(spectra_dataset, embedding_df, morgan_df, device, 
        ...
        x_super_test_with_ext, y_super_test_emb, y_super_test_tox, y_super_test_morgan, super_test_indices_tensor = create_dataset_tensors_condenc_123e1e2_consistent(
        ...
        super_test_save_name = f"super_test_cond_enc_123e1e2_{bin_part}_{threshold_part}_df_spectra"
