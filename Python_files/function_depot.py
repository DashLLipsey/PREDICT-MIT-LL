...
### ======================================= Weighted Loss ======================================= ###
# Code generated by copilot in order to more havily wieght specific parts of the LD50 domain to place higher
# weight on higly toxic chemicals during the regression prediction process
...
### ======================================= REGRESSION ENCODERS ======================================= ###
# All of the encoder architectures and training functions below are built for regression toxcicity prediction
...
# ChemNet Encoder - To predict chemnet emdebbing from spectra 
# batch_size = __
# epochs= __
# lr= 0.0001
...
#%%
# Morgan Fingerprint Encoder - To predict morgan fingerpints from spectra
# batch_size = __
# epochs = __
# lr = 0.0001
criterion = nn.MSELoss()
...
#%%
# Spectra Toxicity MLP - To predict toxicity from spectra (without the use of external conditions)
# batch_size = __
# epochs = __
# lr = 0.0001
# criterion = nn.MSELoss()
...
# Conditional encoder (ChemNet + Toxicity) - First conditontal encoder uses only chemnet and tox
# batch_size = __
# epochs = __
# lr = 0.0001
...
# Conditional Encoder architecture - Uses affine transform on each output part to inform range of predicitons
...
# Conditional encoder with filtered Morgan fingerprints - Final form, conditional encoder with 3 embeddings
# and the toxicity target and 2 external conditions (group and collision energy)
...
# This trianing function is not normalized with the iap (initial and peridic) normalization method
...
### Training function with filtered Morgan fingerprints and without the domain based weighted loss
...
# approach as before. Then we can use those embeddings to predict toxicity in a separate model.
