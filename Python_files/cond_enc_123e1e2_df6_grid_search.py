...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_123e1e2_outputs_df6"
        os.makedirs(output_folder, exist_ok=True)

        predictions_filename = f"cond_enc_{bin_part}_{threshold_part}_df_spectra.parquet"
