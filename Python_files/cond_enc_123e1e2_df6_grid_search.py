...
for i, dataset_name in enumerate(sorted(dataset_names), 1):
    ...
    try:
        ...
        output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_full2_outputs_df6"
...
#         # Save conditional encoder outputs (2561 dimensions + 4 metadata = 2565 columns total)
#         output_folder = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/cond_enc_full_outputs_df6"
#         os.makedirs(output_folder, exist_ok=True)
