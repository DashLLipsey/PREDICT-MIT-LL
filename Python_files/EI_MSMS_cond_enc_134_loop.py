...
# --- Output folders ---
VAL_INT_DIR  = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/2_step_EI_MSMS_Loop_intermediate"
VAL_FINAL_DIR = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/2_step_EI_MSMS_Loop"
SUPER_INT_DIR  = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/2_step_EI_MSMS_Loop_intermediate_super_test"
SUPER_FINAL_DIR = "/home/dlipsey/MITLincolnLabs/MIT_LL_data/2_step_EI_MSMS_loop_super_test"
...
super_test_smiles = [
    ...
    'CCN1CC2(COC)C(OC(C)=O)CC(OC)C34C5CC6(O)C(OC)C(O)C(OC(=O)c5ccccc5)(C5C6OC(=O)c5ccccc5)C(C(OC)C23)C14',
...
for loop_counter in range(num_loops):
    ...
    embedding_config = {
        ...
        'wandb_name': f"step1_embedding_EI_MSMS_{dataset_name}_loop{loop_counter}",
        'gpu': True,
    ...
    tox_config = {
        'wandb_entity': 'dashlipsey-worcester-polytechnic-institute',
        'wandb_project': 'MIT-Lincoln-Lab',
        'wandb_name': f"step2_toxicity_EI_MSMS_{dataset_name}_loop{loop_counter}",
        'gpu': True,
